...
const SignIn:RequestHandler = function (req:Request, res:Response) {
...
const isAuthenticated:RequestHandler = function(req: Request, res:Response, next:NextFunction):void {
    const repository:UserRepository = UserRepository.getInstance();
